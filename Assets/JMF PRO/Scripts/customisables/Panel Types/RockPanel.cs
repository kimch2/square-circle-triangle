...
[AddComponentMenu("JMF/Panels/RockPanel")]
public class RockPanel : PanelDefinition {
	...
	public override void playAudioVisuals(BoardPanel bp){
		bp.master.gm.audioScript.playSound(PlayFx.ROCKP);
		bp.master.gm.animScript.doAnim(animType.ROCKHIT, bp.master.arrayRef[0], bp.master.arrayRef[1] );
	}
}
